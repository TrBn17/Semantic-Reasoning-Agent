...
class DocumentService:
        ...
        *,
        ...
        if not self._is_supported_document(filename):
            raise UnsupportedDocumentTypeError(
                ...
                "Phase 2 currently supports pdf, docx, and xlsx."
            )
    ...
    def process_document(self, document_id: str) -> None:
        ...
        try:
            ...
            parsed_document = parse_document(document.filename, binary_content, document.title)
    ...
    def _is_supported_document(filename: str) -> bool:
        return Path(filename).suffix.lower().lstrip(".") in {"pdf", "docx", "xlsx"}
