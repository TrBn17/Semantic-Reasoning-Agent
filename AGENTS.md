...
| Workspace Admin | Quản lý cấu hình workspace | LLM provider, MCP connectors, quyền truy cập |
...
| Phase 1 | Chat Core & Multi-LLM | Có chat UI, lưu hội thoại, streaming, chọn model/provider |
...
| Phase 4 | MCP Gateway & Agent Tooling | Kết nối MCP server, discover/invoke tools, agent dùng tool có policy |
