...
This project is indexed by GitNexus as **Semantic-Reasoning-Agent** (4302 symbols, 9104 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
